...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Coworkers servicing hvac system",
        },
        {
      ...
      features={[
        {
          icon: Flame,
          title: "System Repair",
          description: "Rapid response for any breakdown.",
        },
        {
          icon: Gauge,
          title: "Installation",
          description: "High-efficiency systems for new builds.",
        },
        {
          icon: ShieldCheck,
          title: "Maintenance",
          description: "Preventative care to save energy.",
        },
        {
          icon: Wind,
          title: "Air Quality",
      ...
      testimonials={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-working-from-home_23-2149187582.jpg",
        },
        {
          id: "2",
          name: "Jane Smith",
          handle: "@janes",
          testimonial: "My AC died during a heatwave and they were here within an hour.",
        ...
        },
        {
          ...
          name: "Bob Lee",
          handle: "@bob",
          testimonial: "Great experience, very transparent pricing.",
        ...
        },
        {
          ...
          name: "Alice Wang",
          handle: "@alicew",
          testimonial: "Polite technicians and excellent cleanup.",
        ...
        },
        {
          ...
          name: "Charlie Brown",
          handle: "@charlie",
          testimonial: "Highly recommended for all heating needs.",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        {
          id: "q4",
          title: "Is emergency service available?",
          content: "Our team is available 24/7 for emergency repairs.",
        },
        {
          id: "q5",
          title: "How often should I change filters?",
          content: "We recommend every 3 months for optimal efficiency.",
        },
      ]}
